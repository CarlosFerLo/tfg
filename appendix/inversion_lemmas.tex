...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item[Case 2] From $\Gamma,x\colon B \vdash s\colon C$, apply \ref{rule:reflection2} to get $\Gamma,x\colon B \vdash C \type$. This is Case~3.
...
\inrulecases*
\begin{proof}
    By simultaneous induction on $|\pi|$ with Lemma \ref{lemma:t-rule-cases}. \\[0.2em]
