...
of these propositions are viewed as terms (or programs) inhabiting
...
\begin{itemize}
    \item \textbf{Chapter 1: The Syntax and Semantics of Generalized Algebraic Theories.}
    ...
    \item \textbf{Chapter 2: The Calculus of Constructions.} We step up the complexity to the Calculus of 
    ...
    \item \textbf{Chapter 3: Implementation of the Expansion Algorithm.} We bring the theory into 
        ...
        using novel unsupervised "Conjecturer-Prover" training paradigm to optimize the expansion process.
