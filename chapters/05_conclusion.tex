...
Although it served to showcase the base concepts behind the expansion algorithm, its design
helped to make future versions of this engines more efficient.
One design mistake we made was to make the API too general, similar to Cypher \cite{francis2018}, 
but it ended up making everything too slow and we did not take any advantage of this general API.
