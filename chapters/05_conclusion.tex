...
which is essential for computing the optimal target labels for our GNN, prohibitively difficult to implement.
...
Future research should systematically reconstruct the underlying categorical models utilizing Voevodsky's 
C-systems \cite{voevodsky2016} and Categories with Families (CwFs) \cite{dybjer96}.
By transitioning away from early contextual categories and adopting these streamlined, modern frameworks, 
the underlying geometry of the automated expansion algorithm will achieve greater mathematical elegance and 
...
prove the Initiality Conjecture and extend the Expansion Algorithm for Doctrines of 
